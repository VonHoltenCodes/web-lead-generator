#!/usr/bin/env python3
"""Interactive Google Business Profile Scraper - Restaurant Edition"""
import asyncio
import sys
from google_scraper_v2 import GoogleBusinessScraperV2
import logging
...
def get_user_input():
    ...
    print("\n" + "="*60)
    print("Google Business Profile Scraper - Restaurant Edition")
    print("="*60)
    print("\nThis scraper finds restaurants without websites.")
    ...
    # Fixed category for restaurants
    category = "restaurant"
...
async def run_interactive_scrape():
    ...
    print(f"\nStarting {mode} scrape for restaurants in '{location}'...")
    print("="*60)
